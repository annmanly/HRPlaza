...
{
    [AddComponentMenu("Lua/HRLiveMarquee")]
    [LuaRegisterType(0x614fc72d709b7f8b, typeof(LuaBehaviour))]
    public class HRLiveMarquee : LuaBehaviourThunk
    {
        private const string s_scriptGUID = "f5cef166bcad54c3480fdee828a38db6";
        ...
        protected override SerializedPropertyValue[] SerializeProperties()
        {
            ...
            return new SerializedPropertyValue[]
            {
                ...
                CreateSerializedProperty(_script.GetPropertyAt(4), m_startDatesTextAsset),
                CreateSerializedProperty(_script.GetPropertyAt(5), m_endDatesTextAsset),
            };
        }
    }
}
